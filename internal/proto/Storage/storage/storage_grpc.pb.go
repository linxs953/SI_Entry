...
const (
	Storage_TestRpc_FullMethodName          = "/Storage.Storage/TestRpc"
...
type StorageClient interface {
	// 测试接口
	TestRpc(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*OperationResponse, error)
	// 添加新任务
...
func (c *storageClient) TestRpc(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*OperationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OperationResponse)
	err := c.cc.Invoke(ctx, Storage_TestRpc_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StorageServer interface {
	// 测试接口
	TestRpc(context.Context, *Empty) (*OperationResponse, error)
	// 添加新任务
...
func (UnimplementedStorageServer) TestRpc(context.Context, *Empty) (*OperationResponse, error) {
...
func _Storage_TestRpc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StorageServer).TestRpc(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Storage_TestRpc_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StorageServer).TestRpc(ctx, req.(*Empty))
	}
...
var Storage_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "TestRpc",
			Handler:    _Storage_TestRpc_Handler,
		},
		{
